...
use crate::internal::scd4x::{
    ...
    GET_SENSOR_ALTITUDE, GET_SERIAL_NUMBER, GET_TEMPERATURE_OFFSET, I2C_ADDRESS,
    PERFORM_FACTORY_RESET, PERFORM_SELF_TEST, PERSIST_SETTINGS, READ_MEASUREMENT, REINIT,
    SET_AMBIENT_PRESSURE, SET_AUTOMATIC_SELF_CALIBRATION_ENABLED, SET_SENSOR_ALTITUDE,
    SET_TEMPERATURE_OFFSET, START_LOW_POWER_PERIODIC_MEASUREMENT, START_PERIODIC_MEASUREMENT,
    ...
    D: DelayNs,
{
    ...
    pub fn set_automatic_self_calibration(&mut self, enabled: bool) -> Result<(), Error<E>> {
        self.inner.set_automatic_self_calibration(enabled)
    }
    ...
    D: DelayNs,
{
    ...
    fn set_automatic_self_calibration(&mut self, enabled: bool) -> Result<(), Error<E>> {
